...
export function iniciarActualizacionDatos(args) {
  ...
  return {
    ...
    instruccion:
      ...
      'Usá parse_appointment_date para la fecha de cita. Si verificar_datos_paciente devuelve needs_time_tiebreaker o needs_context_rescue, pedí la hora o confirmá la cita cercana antes de vincular el número.',
    datos_requeridos: [
      'nombre_completo',
      'fecha_cita',
    ],
